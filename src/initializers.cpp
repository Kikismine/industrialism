...
VkFenceCreateInfo init::fence_create_info(VkFenceCreateFlags flags) {
...
VkSemaphoreCreateInfo init::semaphore_create_info(VkSemaphoreCreateFlags flags) {
...
VkImageSubresourceRange init::image_subresource_range(VkImageAspectFlags aspect_mask) {
...
VkSemaphoreSubmitInfo init::semaphore_submit_info(VkPipelineStageFlags2 stage_mask, VkSemaphore semaphore) {
...
VkCommandBufferSubmitInfo init::command_buffer_submit_info(VkCommandBuffer cmd) {
...
VkSubmitInfo2 init::submit_info(VkCommandBufferSubmitInfo* cmd, VkSemaphoreSubmitInfo* signal_semaphore_info, VkSemaphoreSubmitInfo* wait_semaphore_info) {
    VkSubmitInfo2 info = {};
