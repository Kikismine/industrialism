...
std::vector<char> KvcPipeline::readFile(const std::string& filepath) {
    // read the file (ifstream) and then return its contents
...
// reads vertex and fragment compiled shader files (based on the file paths) and cout the size of them
